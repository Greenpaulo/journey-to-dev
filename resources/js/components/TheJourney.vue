      ...
      <div class="card stage-section p-4 mb-5" id="stage-one">
        ...
        <div class=" card-body">
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-3 my-2"><span class="text-lighter">HTML</span> is a markup language that describes the content and layout of a website.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://www.w3schools.com/Css/css_intro.asp" target="_blank"><img class="pl-2" src="/images/css3.png" alt="css3 logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">CSS</span> (Cascading Style Sheets) is a style sheet language that adds style to your html document/website, adding fonts and colours etc.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-two">
        ...
        <div class=" card-body">
          ...
          <div class="icon-text-group my-2">
            ...
            <p class="lead px-4 my-4"><span class="text-lighter">Materialize</span> is a modern responsive CSS framework based on Material Design by Google.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-three">
        ...
        <div class=" card-body">
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">JavaScript</span> is the programming language of the web. Before learning any JS frameworks it's a good idea to become competent in "vanilla" JavaScript.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-four">
        ...
        <div class=" card-body">
          ...
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">Vue</span> is a progressive framework for building user interfaces. An incrementally adoptable ecosystem that scales between a library and a full-featured framework.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://angularjs.org/" target="_blank"><img src="/images/angular.png" alt="angular.js logo"></a>
            <p class="lead my-2"><span class="text-lighter">Angular</span> is a Javascript framework used for building MVC based applications.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-five">
        ...
        <div class=" card-body">
          ...
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-2 my-2"><span class="text-lighter">PHP</span> is a server scripting language, and a powerful tool for making dynamic and interactive Web pages.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://www.python.org/" target="_blank"><img src="/images/python.png" alt="python logo"></a>
            <p class="lead px-3 my-2"><span class="text-lighter">Python</span> is an interpreted, high-level, general-purpose programming language.
            </p>
          </div>
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">C#</span> is a simple, modern, general-purpose, object-oriented programming language developed by Microsoft.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-six">
        ...
        <div class=" card-body">
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">SQL</span> (Structered Query Language) is a standard language for storing, manipulating and retrieving data in databases.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://www.mysql.com/" target="_blank"><img src="/images/mysql.png" alt="mysql logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">MySQL</span> is an open-source relational database management system.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a class="pl-1 pr-2" href="https://www.mongodb.com/" target="_blank"><img src="/images/mongodb.png" alt="mongodb logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">MongoDB</span> is a cross-platform document-oriented database program. Classified as a NoSQL database program, MongoDB uses JSON-like documents with schema.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-seven">
        ...
        <div class=" card-body">
          ...
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">Laravel</span> is a free, open-source PHP web framework, intended for the development of web applications following the model-view-controller (MVC) architectural pattern.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://docs.microsoft.com/en-us/aspnet/" target="_blank"><img src="/images/asp-net.png" alt="asp.net logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">ASP.NET</span> is an open-source server-side web application framework designed by Microsoft for web development to produce dynamic web pages.
            </p>
          </div>
          <div class="icon-text-group my-4">
      ...
      <div class="card stage-section p-4 mb-5" id="stage-eight">
        ...
        <div class=" card-body">
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">Git</span> is a free and open source distributed version control system designed to handle everything from small to very large projects with speed and efficiency
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://github.com/" target="_blank"><img src="/images/github.png" alt="github logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">Github</span> is an American company that provides hosting for software development version control using Git. 
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="card stage-section p-4 mb-5" id="stage-nine">
        ...
        <div class=" card-body">
          <div class="icon-text-group my-4">
            ...
            <p class="lead px-4 my-2"><span class="text-lighter">Netlify</span> is a cloud computing company that offers hosting and serverless backend services for static websites.
            </p>
          </div>
          <div class="icon-text-group my-4">
            <a href="https://www.digitalocean.com/" target="_blank"><img src="/images/digitalocean.png" alt="digital ocean logo"></a>
            <p class="lead px-4 my-2"><span class="text-lighter">DigitalOcean</span> is a cloud infrastructure provider with data centers worldwide. DigitalOcean provides developers cloud services that help to deploy and scale applications that run simultaneously on multiple computers. 
            </p>
          </div>
          <div class="icon-text-group my-4">
